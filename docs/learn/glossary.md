...
A changeable ledger of transactions copied among a network of colluding computer systems, subject to [the centralized authority of a Twitter account](https://archive.ph/dpz3x).
